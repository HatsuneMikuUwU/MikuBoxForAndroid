...
// MVS resolves gvisor to the older v0.0.0-20250325023245-7a9c0f5725fb: under
// semver prerelease precedence the numeric identifier "20250811" ranks below
// the alphanumeric "20250325023245-7a9c0f5725fb". Force the version sing-box,
// sing-tun and tailscale are actually built against.
